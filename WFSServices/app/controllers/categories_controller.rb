class CategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @category.save
        format.html { redirect_to services_path, notice: 'Category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @category.update(category_params)
        format.html { redirect_to services_url, notice: 'Category was successfully updated.' }
